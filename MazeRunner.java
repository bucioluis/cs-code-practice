//UIUC CS125 FALL 2014 MP. File: MazeRunner.java, CS125 Project: Challenge7-RecursiveKnight, Version: 2015-04-20T07:56:24-0500.863101473
public class MazeRunner {
	...
	static int findShortestString(String[] paths, int lo, int hi) {
		...
		if( lo > hi) return -1;
		if( lo == hi) return lo;
		if(safeStringLength(paths[lo]) > safeStringLength(paths[hi]))
				return findShortestString(paths, lo + 1, hi);
		else return findShortestString(paths, lo, hi-1);// TODO: findShortestString
	}
